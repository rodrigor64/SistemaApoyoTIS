...
(function ( $ ) {
			...
			$.each(array, function(date,events) {
				...
				$.each(events, function(ev,evdata) {
					...
					tempeventarray["location"] = evdata.location;
                                        tempeventarray["codigo"] = evdata.codigo;
			...
			$(this).find('[data-role=day]').each(function() {
				...
				$(this).find('[data-role=event]').each(function() {
					...
					tempeventarray["location"] = $(this).data("location");
                                        tempeventarray["codigo"] = $(this).data("codigo");
					tempdayarray.push(tempeventarray);
				});
	...
	var tocalendar = function() {
		...
		for(var o = 0; o<ev.length;o++) {
                    if (ev[o]['name']=="Reunion semanal de seguimiento")
                    {
                        $(".specific-day-scheme").append('<div class="specific-day-scheme-event"><a href= "../Vista/iuSeguimientoGrupoEmpresa.php?a='+ev[o]['location']+'&b='+ev[o]['codigo']+'"><h1>'+ev[o]['name']+'</h1></a><p data-role="dur">'+ev[o]['start']+' '+ev[o]['end']+'</p><p data-role="loc"></p><p data-role="cod"></p></div>');
                    
                    }    
                    else{
                        $(".specific-day-scheme").append('<div class="specific-day-scheme-event"><a href= "../Vista/iuHitoPagableGrupoEmpresa.php?a='+ev[o]['location']+'&b='+ev[o]['codigo']+'"><h1>'+ev[o]['name']+'</h1></a><p data-role="dur">'+ev[o]['start']+' '+ev[o]['end']+'</p><p data-role="loc"></p></div>');
